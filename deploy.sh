...
# Env Vars
DOMAIN_NAME="emmfortgroup.com" # replace with your own
EMAIL="victoreleanya89@example.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/mrvicthor/emm-fort.git"
APP_DIR=~/myapp
...
DATABASE_URL="mongodb+srv://victoreleanya89:Hr24r0JvWvdpEZQH@cluster0.d49p2.mongodb.net/emm-fort-db?retryWrites=true&w=majority&appName=Cluster0"
